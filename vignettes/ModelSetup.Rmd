...
First, install Rpath as instructed in [Getting Started](https://noaa-edab.github.io/Rpath/articles/Rpath.html). R package `data.table` is also required to run the code in this article.
