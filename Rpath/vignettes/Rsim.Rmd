...
`rsim.scenario` function are the Rpath object, the rpath parameter object, and the 
...
created in the first step.  For example, we can double the effort of the trawler fleet after 25 years.
