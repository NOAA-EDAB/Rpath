...
#'@param group Name of the species group whose fishing parameter is being changed.
...
#'@export 
adjust.fishing <- function(Rsim.scenario, parameter, group = NA, year, value){
  ...
  year.row <- which(rownames(Rsim.scenario$fishing[[parameter]]) %in% year)
