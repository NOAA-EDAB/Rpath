...
testthat::test_that("Rpath Unit Tests", {
  ...
  if (! CREATE_BASELINE_FILES) {
    ...
    REcosystemBaselineSummary                              <- readRDS(BaselineRpathObjSummary,                fill = TRUE)
    ...
    REcosystem_Baseline_RK4_OutBiomass                     <- readRDS(BaselineRK4OutBiomass,                  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_OutCatch                       <- readRDS(BaselineRK4OutCatch,                    fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_OutGearCatch                   <- readRDS(BaselineRK4OutGearCatch,                fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedBio_OutBiomass_Stepped    <- readRDS(BaselineABForcedBioOutBiomassStepped,   fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedBio_OutBiomass_Stepped   <- readRDS(BaselineRK4ForcedBioOutBiomassStepped,  fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedBio_OutCatch_Stepped      <- readRDS(BaselineABForcedBioOutCatchStepped,     fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedBio_OutCatch_Stepped     <- readRDS(BaselineRK4ForcedBioOutCatchStepped,    fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedBio_OutGearCatch_Stepped  <- readRDS(BaselineABForcedBioOutGearCatchStepped, fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedBio_OutGearCatch_Stepped <- readRDS(BaselineRK4ForcedBioOutGearCatchStepped,fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedBio_OutBiomass_Jitter     <- readRDS(BaselineABForcedBioOutBiomassJitter,    fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedBio_OutBiomass_Jitter    <- readRDS(BaselineRK4ForcedBioOutBiomassJitter) #,   fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedBio_OutCatch_Jitter       <- readRDS(BaselineABForcedBioOutCatchJitter,      fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedBio_OutCatch_Jitter      <- readRDS(BaselineRK4ForcedBioOutCatchJitter,     fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedBio_OutGearCatch_Jitter   <- readRDS(BaselineABForcedBioOutGearCatchJitter,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedBio_OutGearCatch_Jitter  <- readRDS(BaselineRK4ForcedBioOutGearCatchJitter, fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedMig_OutBiomass_Stepped    <- readRDS(BaselineABForcedMigOutBiomassStepped,   fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedMig_OutBiomass_Stepped   <- readRDS(BaselineRK4ForcedMigOutBiomassStepped,  fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedMig_OutCatch_Stepped      <- readRDS(BaselineABForcedMigOutCatchStepped,     fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedMig_OutCatch_Stepped     <- readRDS(BaselineRK4ForcedMigOutCatchStepped,    fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedMig_OutGearCatch_Stepped  <- readRDS(BaselineABForcedMigOutGearCatchStepped, fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedMig_OutGearCatch_Stepped <- readRDS(BaselineRK4ForcedMigOutGearCatchStepped,fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedMig_OutBiomass_Jitter     <- readRDS(BaselineABForcedMigOutBiomassJitter,    fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedMig_OutBiomass_Jitter    <- readRDS(BaselineRK4ForcedMigOutBiomassJitter) #,   fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedMig_OutCatch_Jitter       <- readRDS(BaselineABForcedMigOutCatchJitter,      fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedMig_OutCatch_Jitter      <- readRDS(BaselineRK4ForcedMigOutCatchJitter,     fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedMig_OutGearCatch_Jitter   <- readRDS(BaselineABForcedMigOutGearCatchJitter,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedMig_OutGearCatch_Jitter  <- readRDS(BaselineRK4ForcedMigOutGearCatchJitter, fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutBiomass_Stepped    <- readRDS(BaselineABForcedEffOutBiomassStepped,   fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutBiomass_Stepped   <- readRDS(BaselineRK4ForcedEffOutBiomassStepped,  fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutCatch_Stepped      <- readRDS(BaselineABForcedEffOutCatchStepped,     fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutCatch_Stepped     <- readRDS(BaselineRK4ForcedEffOutCatchStepped,    fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutGearCatch_Stepped  <- readRDS(BaselineABForcedEffOutGearCatchStepped, fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutGearCatch_Stepped <- readRDS(BaselineRK4ForcedEffOutGearCatchStepped,fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutBiomass_Jitter     <- readRDS(BaselineABForcedEffOutBiomassJitter,    fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutCatch_Jitter       <- readRDS(BaselineABForcedEffOutCatchJitter,      fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutGearCatch_Jitter   <- readRDS(BaselineABForcedEffOutGearCatchJitter,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutBiomass_Jitter    <- readRDS(BaselineRK4ForcedEffOutBiomassJitter,   fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutCatch_Jitter      <- readRDS(BaselineRK4ForcedEffOutCatchJitter,     fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutGearCatch_Jitter  <- readRDS(BaselineRK4ForcedEffOutGearCatchJitter, fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedFRa_OutBiomass_Jitter     <- readRDS(BaselineABForcedFRaOutBiomassJitter,    fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedFRa_OutCatch_Jitter       <- readRDS(BaselineABForcedFRaOutCatchJitter,      fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedFRa_OutGearCatch_Jitter   <- readRDS(BaselineABForcedFRaOutGearCatchJitter,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedFRa_OutBiomass_Jitter    <- readRDS(BaselineRK4ForcedFRaOutBiomassJitter,   fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedFRa_OutCatch_Jitter      <- readRDS(BaselineRK4ForcedFRaOutCatchJitter,     fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedFRa_OutGearCatch_Jitter  <- readRDS(BaselineRK4ForcedFRaOutGearCatchJitter, fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedCat_OutBiomass_Jitter     <- readRDS(BaselineABForcedCatOutBiomassJitter,    fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedCat_OutCatch_Jitter       <- readRDS(BaselineABForcedCatOutCatchJitter,      fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedCat_OutGearCatch_Jitter   <- readRDS(BaselineABForcedCatOutGearCatchJitter,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedCat_OutBiomass_Jitter    <- readRDS(BaselineRK4ForcedCatOutBiomassJitter,   fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedCat_OutCatch_Jitter      <- readRDS(BaselineRK4ForcedCatOutCatchJitter,     fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedCat_OutGearCatch_Jitter  <- readRDS(BaselineRK4ForcedCatOutGearCatchJitter, fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutBiomass_Stepped    <- readRDS(BaselineABForcedEffOutBiomassStepped,   fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutCatch_Stepped      <- readRDS(BaselineABForcedEffOutCatchStepped,     fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedEff_OutGearCatch_Stepped  <- readRDS(BaselineABForcedEffOutGearCatchStepped, fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutBiomass_Stepped   <- readRDS(BaselineRK4ForcedEffOutBiomassStepped,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutCatch_Stepped     <- readRDS(BaselineRK4ForcedEffOutCatchStepped,    fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedEff_OutGearCatch_Stepped <- readRDS(BaselineRK4ForcedEffOutGearCatchStepped,fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedFRa_OutBiomass_Stepped    <- readRDS(BaselineABForcedFRaOutBiomassStepped,   fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedFRa_OutCatch_Stepped      <- readRDS(BaselineABForcedFRaOutCatchStepped,     fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedFRa_OutGearCatch_Stepped  <- readRDS(BaselineABForcedFRaOutGearCatchStepped, fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedFRa_OutBiomass_Stepped   <- readRDS(BaselineRK4ForcedFRaOutBiomassStepped,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedFRa_OutCatch_Stepped     <- readRDS(BaselineRK4ForcedFRaOutCatchStepped,    fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedFRa_OutGearCatch_Stepped <- readRDS(BaselineRK4ForcedFRaOutGearCatchStepped,fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedCat_OutBiomass_Stepped    <- readRDS(BaselineABForcedCatOutBiomassStepped,   fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedCat_OutCatch_Stepped      <- readRDS(BaselineABForcedCatOutCatchStepped,     fill = TRUE, sep = " ")
    REcosystem_Baseline_AB_ForcedCat_OutGearCatch_Stepped  <- readRDS(BaselineABForcedCatOutGearCatchStepped, fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedCat_OutBiomass_Stepped   <- readRDS(BaselineRK4ForcedCatOutBiomassStepped,  fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedCat_OutCatch_Stepped     <- readRDS(BaselineRK4ForcedCatOutCatchStepped,    fill = TRUE, sep = " ")
    REcosystem_Baseline_RK4_ForcedCat_OutGearCatch_Stepped <- readRDS(BaselineRK4ForcedCatOutGearCatchStepped,fill = TRUE, sep = " ")
  }
  ...
  if (! CREATE_BASELINE_FILES) {
    ...
    REcosystemSummaryCurrent <- readRDS(CurrentRpathObjSummary,fill = TRUE)
...
return()
  ...
  for (i in 1:length(typeData)) {
    ...
    if (CREATE_BASELINE_FILES) {
      saveRDS(REcosystem_AB_Current_Stepped$out_Biomass,     file=BaselineSteppedFiles[[1]])
      saveRDS(REcosystem_AB_Current_Stepped$out_Catch,       file=BaselineSteppedFiles[[2]])
      saveRDS(REcosystem_AB_Current_Stepped$out_Gear_Catch,  file=BaselineSteppedFiles[[3]])
      saveRDS(REcosystem_RK4_Current_Stepped$out_Biomass,    file=BaselineSteppedFiles[[4]])
      saveRDS(REcosystem_RK4_Current_Stepped$out_Catch,      file=BaselineSteppedFiles[[5]])
      saveRDS(REcosystem_RK4_Current_Stepped$out_Gear_Catch, file=BaselineSteppedFiles[[6]])
    } else {
      saveRDS(REcosystem_AB_Current_Stepped$out_Biomass,     file=CurrentSteppedFiles[[1]])
      saveRDS(REcosystem_AB_Current_Stepped$out_Catch,       file=CurrentSteppedFiles[[2]])
      saveRDS(REcosystem_AB_Current_Stepped$out_Gear_Catch,  file=CurrentSteppedFiles[[3]])
  ...
  for (i in 1:length(fishingOriginalData)) {
    ...
    if (CREATE_BASELINE_FILES) {
      saveRDS(REcosystem_AB_Current_Jitter$out_Biomass,     file=BaselineJitterFiles[[1]])
      saveRDS(REcosystem_AB_Current_Jitter$out_Catch,       file=BaselineJitterFiles[[2]])
      saveRDS(REcosystem_AB_Current_Jitter$out_Gear_Catch,  file=BaselineJitterFiles[[3]])
      saveRDS(REcosystem_RK4_Current_Jitter$out_Biomass,    file=BaselineJitterFiles[[4]])
      saveRDS(REcosystem_RK4_Current_Jitter$out_Catch,      file=BaselineJitterFiles[[5]])
      saveRDS(REcosystem_RK4_Current_Jitter$out_Gear_Catch, file=BaselineJitterFiles[[6]])
    } else {
      saveRDS(REcosystem_AB_Current_Jitter$out_Biomass,     file=CurrentJitterFiles[[1]])
      saveRDS(REcosystem_AB_Current_Jitter$out_Catch,       file=CurrentJitterFiles[[2]])
      saveRDS(REcosystem_AB_Current_Jitter$out_Gear_Catch,  file=CurrentJitterFiles[[3]])
