...
#'@param parameter One of three parameters to be modified: Effort, ForcedFRate, 
#'                 or ForcedCatch
...
adjust.fishing <- function(Rsim.scenario, parameter, group = NA, sim.year = 1, 
  ...
  if(!parameter %in% c('Effort', 'ForcedFRate', 'ForcedCatch')){stop("Fishing parameter not found")}
