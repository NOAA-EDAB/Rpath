...
#' AB.params
#'
#' Anchovy Bay (\code{AB.params}) is a sample ecosystem frequently used as an example ecosystem with EwE (see Christensen and Walters, 2024).
#'
...
#'   ...
#' }
#' @source Christensen V, Walters CJ (2024) Ecosystem Modelling with EwE. The University of British Columbia, Vancouver, BC. doi:10.14288/24d7-ab68
#' @examples
#' # Balance the model
...
#'   ...
#' }
#' @note This is an aggregated version of the 1990s eastern Bering Sea Ecopath model of Aydin et al. (2007) and does not include stanzas.
...
#' @references Aydin KY, Gaichas S, Ortiz I, Kinzey D, Friday N (2007) A comparison of the Bering Sea, Gulf of Alaska, and Aleutian Islands large marine ecosystems through food web modeling. U.S. Dep. Commer., NOAA Tech. Memo. NMFS-AFSC-178. 
#' @examples
#' # Balance the model
...
#'   ...
#' }
#' @note This is an aggregated version of the 1990s Gulf of Alaska Ecopath model of Aydin et al. (2007) and does not include stanzas.
#' @source Whitehouse and Aydin 2020.  Assessing the sensitivity of three Alaska marine food webs to perturbations: an example of Ecosim simulations using Rpath. https://doi.org/10.1016/j.ecolmodel.2020.109074  
#' @references Aydin KY, Gaichas S, Ortiz I, Kinzey D, Friday N (2007) A comparison of the Bering Sea, Gulf of Alaska, and Aleutian Islands large marine ecosystems through food web modeling. U.S. Dep. Commer., NOAA Tech. Memo. NMFS-AFSC-178. 
#' @examples
#' # Balance the model
...
#'   ...   
#' }
#' @note This is an aggregated version of the eastern Chukchi Sea Ecopath model of Whitehouse and Aydin (2016).
#' @source Whitehouse and Aydin 2020.  Assessing the sensitivity of three Alaska marine food webs to perturbations: an example of Ecosim simulations using Rpath. https://doi.org/10.1016/j.ecolmodel.2020.109074  
#' @references Whitehouse GA, Aydin KY (2016) Trophic structure of the eastern Chukchi Sea: An updated mass balance food web model. U.S. Dep Commer, NOAA Tech. Memo. NMFS-AFSC-318. doi:10.7289/V5/TM-AFSC-318 
#' @examples
#' # Balance the model
