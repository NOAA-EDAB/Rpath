...
#'@param method Numerical integration method. Either 'AB' for Adams-Bashforth or 
...
#'
#'Creates a matrix for forcing functions related to fishing (ForcedEffort, 
#'ForcedFRate, ForcedCatch)
#'
#'@inheritParams rsim.scenario
#'@param params Rsim parameter object generated by `rsim.params`.
#'
#'@export
#'
...
#'
#'Creates a matrix for forcing functions not related to fishing (ForcedPrey
#'ForcedMort, ForcedRecs, ForcedSearch, ForcedMigrate, ForcedBio).
#'
...
#'
#'@param Rsim.output R object containing the output from `rsim.run`.
#'@param group Group from the Rpath model that is of interest
#'
#'@export
#'
...
#'
#'@return Returns an Rpath.sim object that can be supplied to the rsim.run function.
#'
#'@export
#'
...
#'
#'@inheritParams rsim.fishing
#'@param state List object of state variables generated by `rsim.state` 
#'
#'@export
#'
