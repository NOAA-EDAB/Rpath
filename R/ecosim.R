...
#'
#'Creates a matrix for forcing functions related to fishing (\emp{ForcedEffort}, 
#'\emp{ForcedFRate}, \emp{ForcedCatch})
#'
#'@inheritParams rsim.scenario
...
#'
#'Creates a matrix for forcing functions not related to fishing (\emp{ForcedPrey}
#'\emp{ForcedMort}, \emp{ForcedRecs}, \emp{ForcedSearch}, \emp{ForcedMigrate}, 
#'\emp{ForcedBio}).
#'
